...
values (22, 'JOB_34', 'action', 'self.take_resource(player, {''wood'': 1})',
        'round_card_number in ["BASE_13", "BASE_01", "BASE_02"] and is_my_turn');
insert into cards_cardeffect (id, card_number, effect, command, condition)
...
values (19, 'JOB_21', 'action', 'self.take_resource(player, {''wood'': 1})',
        'round_card_number in ["ACTION_01",  "BASE_09", "BASE_10", "ACTION_12"] and is_my_turn');
insert into cards_cardeffect (id, card_number, effect, command, condition)
...
insert into cards_cardeffect (id, card_number, effect, command, condition)
values (24, 'JOB_18', 'action', 'self.take_resource(player, {''vegetable'': 1})',
        'round_card_number == "BASE_09" and is_my_turn');
insert into cards_cardeffect (id, card_number, effect, command, condition)
values (21, 'JOB_25', 'action', 'self.take_resource(player, {''clay'': 1})',
        'round_card_number == "BASE_03" and is_my_turn');
insert into cards_cardeffect (id, card_number, effect, command, condition)
values (4, 'SUB_FAC_10', 'action',
        'self.add_effect_on_round_cards(turn, round_cards, now_round, {''food'': 1}, "next", 3)',
        'round_card_number == "BASE_16" and is_my_turn');
insert into cards_cardeffect (id, card_number, effect, command, condition)
values (18, 'JOB_12', 'immediately', 'self.take_resource(player, {''sheep'': 2})', null);
insert into cards_cardeffect (id, card_number, effect, command, condition)
values (29, 'SUB_FAC_01', 'round', 'self.take_resource(player, {''food'': 1})',
        'player.get(''house_type'') == HouseType.WOOD_HOUSE');
insert into cards_cardeffect (id, card_number, effect, command, condition)
values (30, 'JOB_09', 'round', 'self.take_resource(player, {''food'': 1, ''grain'': 1})',
        'len(list(filter(lambda p: p.get(''field_type'') == FieldType.ROOM, player.get("fields")))) == 3 and player.get("resource").get("family") == 2');
insert into cards_cardeffect (id, card_number, effect, command, condition)
values (31, 'JOB_05', 'round', 'self.take_resource(player, {''wood'': 1})',
        'len(list(filter(lambda p: p.get(''field_type'') == FieldType.ROOM, player.get("fields")))) == 2');
insert into cards_cardeffect (id, card_number, effect, command, condition)
values (7, 'SUB_FAC_18', 'action', 'self.take_resource(player, {''clay'': 3})',
        'round_card_number == "BASE_12" and is_my_turn');
insert into cards_cardeffect (id, card_number, effect, command, condition)
values (8, 'SUB_FAC_21', 'action', 'self.take_resource(player, {''grain'': 1})',
        'round_card_number == "BASE_09" and is_my_turn');
insert into cards_cardeffect (id, card_number, effect, command, condition)
values (26, 'SUB_FAC_22', 'action', 'self.take_resource(player, {''food'': 1})',
        'round_card_number in ["ACTION_07", "ACTION_06", "ACTION_03", "BASE_08"] and is_my_turn');
insert into cards_cardeffect (id, card_number, effect, command, condition)
values (23, 'JOB_30', 'action', 'self.take_resource(player, {''clay'': 1})',
        'round_card_number in ["BASE_13", "BASE_14", "BASE_15"] and is_my_turn');
insert into cards_cardeffect (id, card_number, effect, command, condition)
...
values (9, 'SUB_FAC_25', 'action', 'self.take_resource(player, {''stone'': 1})',
        'round_card_number in ["ACTION_05", "ACTION_10"] and is_my_turn');
insert into cards_cardeffect (id, card_number, effect, command, condition)
...
values (3, 'JOB_03', 'action', 'self.add_effect_on_round_cards(turn, round_cards, now_round, {''food'': 1}, "next", 4)',
        'round_card_number == "BASE_07" and is_my_turn');
insert into cards_cardeffect (id, card_number, effect, command, condition)
values (25, 'JOB_37', 'action', 'self.take_resource(player, {''wood'': 1, ''grain'': 1})',
        'round_card_number == "BASE_06" and is_my_turn');
